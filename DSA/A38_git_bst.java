...
// START 4 - Print 2D
	public void print2D(Node r, int space) {
		...
		print2D(r.right, space + A38_git_bst.GLOBALSPACE);
		System.out.println();
		for (int i = A38_git_bst.GLOBALSPACE; i < space; i++)
			System.out.print(" ");

		System.out.println(r.data);
		print2D(r.left, space + A38_git_bst.GLOBALSPACE);
	}
// END 4 - Print 2D
...
// START 7 - Total Number of Nodes in the Tree
	public int countNodes(Node r) {
		...
		return leftCount + rightCount + 1;		// +1 for count of root also
	}
